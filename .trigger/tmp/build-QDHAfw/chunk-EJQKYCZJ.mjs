...
var TaskContextAPI = class _TaskContextAPI {
  ...
  setGlobalTaskContext(taskContext2) {
    return registerGlobal(API_NAME7, taskContext2);
  }
  #getTaskContext() {
...
var UsageAPI = class _UsageAPI {
  ...
  #getUsageManager() {
    return getGlobal(API_NAME8) ?? NOOP_USAGE_MANAGER;
  }
};
...
var RuntimeAPI = class _RuntimeAPI {
  ...
  setGlobalRuntimeManager(runtimeManager) {
    return registerGlobal(API_NAME9, runtimeManager);
  }
  disable() {
  ...
  #getRuntimeManager() {
    return getGlobal(API_NAME9) ?? NOOP_RUNTIME_MANAGER;
  }
};
...
var APIClientManagerAPI = class _APIClientManagerAPI {
  ...
  setGlobalAPIClientConfiguration(config) {
    return registerGlobal(API_NAME10, config);
  }
  get baseURL() {
...
var TaskCatalogAPI = class _TaskCatalogAPI {
  ...
  setGlobalTaskCatalog(taskCatalog2) {
    return registerGlobal(API_NAME11, taskCatalog2);
  }
  disable() {
  ...
  #getCatalog() {
    return getGlobal(API_NAME11) ?? NOOP_TASK_CATALOG;
  }
};
...
async function loadSuperJSON() {
  const superjson = await import("./dist-UBH2GZJO.mjs");
...
@google-cloud/precise-date/build/src/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-EJQKYCZJ.mjs.map
