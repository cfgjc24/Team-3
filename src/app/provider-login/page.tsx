  ...
  return (
    <Card className="w-[400px]">
      <CardHeader className="space-y-1">
        ...
        <CardDescription className="text-sm">Enter your credentials to access the Provider panel.</CardDescription>
      </CardHeader>
      ...
      <CardFooter>
        <Button className="w-full h-10" type="submit" onClick={handleSubmit}>Sign In</Button>
      </CardFooter>
    </Card>
  );
};
